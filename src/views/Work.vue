<template>
  <div class="work">
    <p>Below are some artwork jobs/logos I have done during my time at <site-link type="external" link="https://www.mirical-emblems.com">MiRiCal Emblems</site-link>.</p>
    <p>For other designs and photography I have done, please see a collection of my portfolio on <site-link type="external" :link="commonMedia.pinterest.url">{{ commonMedia.pinterest.platform }}</site-link>, <site-link type="external" :link="commonMedia.instagram.url">{{ commonMedia.instagram.platform }}</site-link>, <site-link type="external" :link="commonMedia.gurushots.url">{{ commonMedia.gurushots.platform }}</site-link>, <site-link type="external" :link="commonMedia.dribbble.url">{{ commonMedia.dribbble.platform }}</site-link> and <site-link type="external" :link="commonMedia.designcrowd.url">{{ commonMedia.designcrowd.platform }}</site-link>.</p>
    <section>
...
import CommonInfo, { IMedias } from '@/helpers/CommonInfo';
